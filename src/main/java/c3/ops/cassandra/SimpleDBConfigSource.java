 ...
 * amazon's auto scaling groups (Ring).
 * <p/>
 * Schema <ul>
 * <li>"appId" // Ring up to first instance of '-'.  So Ring name priam-test will create appId priam, Ring priam_test
...
public final class SimpleDBConfigSource extends AbstractConfigSource {
	...
	public void intialize(final String ringName, final String region) {
		...
		String appid = ringName.lastIndexOf('-') > 0 ? ringName.substring(0, ringName.indexOf('-')) : ringName;
	...
	private static class Attributes {
		public final static String APP_ID = "appId"; // Ring
